export default {
    ...
    getText(gameState) {
        const text = gameState.language === 'en' ? {
            ...
            monologue1: "(Лина и Амина вальяжно сидят в уютном кафе, потягивают латте. Лина с хитрой ухмылкой тычет телефоном в лицо Амине, показывая фотку твоего дружка .)",
            monologue2: "(Амина давится латте, ржёт до слёз.)",
            amina1: "Лина, что за хуйня?! Это ж как креветочка! Ты его вообще чувствуешь?",
            monologue3: "(Лина фыркает, еле сдерживая смех.)",
            lina1: "Кек, ну, когда старается. но, блин, мне иногда хочется.. ну ты понимаешь? покажи, какой у твоего!",
            monologue4: "(Амина с ухмылкой достаёт телефон.)",
            amina2: "Если у твоего креветка, то у моего - ... Кто там креветок ест?!",
            monologue5: "(Лина ахает, зумит фотку.)",
            lina2: "Ебать, Амина, это ж монстр! У меня даже дилдо меньше!",
            monologue6: "(Амина наклоняется ближе, голос низкий, дразнящий.)",
            amina3: "О да, я потом хромаю неделю. А может вам обсудить с парнем немного другой формат отношений? кек, пусть посмотрит, как надо",
            monologue7: "(Лина ржёт, прикусывая губу, щёки горят.)",
            lina3: "Я бы кончила за секунды с ним, наверное.. Слушай, а может реально спросить, не против ли он куколдом стать, ахаха!",
