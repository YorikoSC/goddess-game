export default {
  getText(gameState) {
    const texts = gameState.language === 'en' ? {
      ...
      msg1: "Привет, милый! 😘 Вали в кафешку с Аминой, моей подругой. Не реви без своей королевы, ага? 😉",
  ...
  getChoices(gameState) {
    const texts = gameState.language === 'en' ? {
      ...
      msg9: "Вау, правда? Не ожидал такого...",
      msg10: "Лина, зачем тебе фотка моего члена, если ты с Аминой? Как-то стремно...",
      msg11: "Ха, просто прикол, глупый! Захотела глянуть на богатство своего парня за латте! 😜",
      ...
      msg15: "Она угорала, сказала, что он крошечный, но милый. А её? Сука, у её парня просто пушка! Мы ржали до слёз! 😈",
      msg16: "Пушка? То есть он намного больше?",
      msg17: "О да, огромный! Она такая Лина меняй своего на этого монстра! Шутка, ясное дело, ты мой маленький чемпион! 😉",
      msg18: "Менять меня? Это не прикол, Лина...",
      msg19: "Да не ной, не будь такой нежной цацей! Просто девчачьи тёрки, кекеке. Ты всё равно мой номер один, с маленьким хуем или без! 😏",
      ...
      msg25: "Да успокойся, не трынди! Мы просто поржали, кекеке. Она сказала, что он милый, но я такая типа всё равно люблю свою креветочку! 😏",
      msg26: "Не трынди?! Ты фотку моего члена подруге показала! Ты серьёзно, Лина?",
      msg27: "Окей, окей, сорри, милый! Мы заигрались. Но если честно, у Амины парень с такой пушкой, что мы начали ржать и думать, как бы ты отреагировал, если б увидел! 😈",
      msg28: "Отреагировал? В смысле? Ты думаешь, мне бы это понравилось?",
      msg29: "Ну кекеке, мы подумали, может, тебе бы зашло! Амина такая а вдруг он в куколды хочет? Но я ей сказала, что ты всё равно мой любимый, с креветочкой или без! 😘",
      msg30: "В куколды?! Ты сейчас серьёзно? Я в шоке, что ты такое вообще сказала...",
      msg31: "Милый, не злись! Это просто прикол, кекеке. Но если тебе интересно, я бы не против... может, замутим что-то новенькое? 😏",
      msg32: "Я... мне надо подумать. Это слишком для меня сейчас.",
      msg33: "Окей, думай, моя креветочка! Я тут, если захочешь поболтать... или попробовать что-то новенькое, кекеке! Споки-споки! 😘",
      msg34: "Пиздец, всё, отвали. Не пиши мне сегодня.",
      msg35: "Ой, милый, не кипятись! Ладно, отстану. Отоспись, потом поговорим, ок? 😔",
      msg36: "Ладно, справлюсь. Давай завтра обсудим.",
      msg37: "Ура, мой сладкий! Классный настрой. Чат завтра, спи крепко! 😘",
      resultEnd: "Ладно, отрывайся... Я пока выключусь. Спокойной."
    };
