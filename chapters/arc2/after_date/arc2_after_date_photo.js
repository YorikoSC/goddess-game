export default {
    getText(gameState) {
        const texts = gameState.language === 'en' ? {
            msg1: "When you came back from the bathroom, your bra strap was down on your shoulder. As if you were taking some intimate photo."
        } : {
            msg1: "Когда ты вернулась из туалета, у тебя была спущена бретелька лифчика на плече. Как будто ты делала какую-то интимную фотографию."
        };
