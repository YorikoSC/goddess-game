const GameData = {
  ru:
  {
    ...
    chapter6_study_together:
    {
      ...
      {
        type: "sent",
        text: "Думаю, нам стоит встретиться и вместе подготовиться к экзаменам.",
        delay: 1000
      },
      {
        type: "received",
        text: "Хорошая идея! 📚 А то я совсем не понимаю интегралы...",
        delay: 2500
      },
      {
        type: "received",
        text: "Может, встретимся в библиотеке завтра?",
        delay: 4000
      },
      ],
      choices: [
      {
        text: "Да, библиотека подойдёт. Приду со всеми конспектами!",
        result: [
        {
          type: "received",
          text: "Отлично! Буду ждать тебя там! 🤓",
          delay: 1000
        }],
        nextChapter: "chapter_homework"
      },
      {
        text: "А может лучше у тебя дома? Так будет удобнее заниматься.",
        result: [
        {
          type: "received",
          text: "Хм... Ну хорошо! Завтра родители уезжают, так что никто не будет мешать нам учиться 😌",
          delay: 1000
        }],
        nextChapter: "chapter_homework"
      }],
    ...
    chapter_homework:
    {
      ...
      {
        type: "received",
        text: "Привет! Слушай, у меня к тебе предложение... 📚",
        delay: 1000
      },
      {
        type: "sent",
      ...
      {
        type: "received",
        text: "Может, сделаем домашку по высшей математике вместе? Я уже час сижу над этими интегралами... 😵‍💫",
        delay: 4000
      },
      {
        type: "received",
        text: "Приходи ко мне домой вечером? Родители уехали на дачу до завтра 🏡",
        delay: 5500
      },
      ],
      choices: [
      {
        text: "Конечно! Я с радостью помогу тебе с математикой.",
        result: [
        {
          type: "received",
          text: "Отлично! Только не забудь свои конспекты, у меня не все лекции записаны 📝",
          delay: 1000
        },
        {
          type: "received",
          text: "И знаешь что... Если не забудешь конспекты, я сделаю тебе особый подарок 😏",
          delay: 2500
        }],
        nextChapter: "chapter_homework_2"
      },
      {
        text: "У тебя дома? Наедине? Звучит интересно...",
        result: [
        {
          type: "received",
          text: "Эй, не думай о всяких глупостях! 😂 Мы будем УЧИТЬСЯ!",
          delay: 1000
        },
        {
          type: "received",
          text: "Но если принесёшь конспекты... может, сделаю тебе приятный сюрприз 🙊",
          delay: 2500
        }],
        nextChapter: "chapter_homework_2"
      }],
    ...
    chapter_homework_2:
    {
      ...
      {
        type: "sent",
        text: "Какой ещё подарок? Теперь мне точно интересно!",
        delay: 1000
      },
      {
        type: "received",
        text: "Хм... 🤔 Знаю, что тебе понравится. Если принесёшь конспекты, сделаю тебе фото своих босых ножек 👣",
        delay: 2500
      },
      {
        type: "received",
        text: "Ты ведь вечно на них пялишься, когда я в сандалиях хожу, думаешь я не замечаю? 😏",
        delay: 4000
      },
      ],
      choices: [
      {
        text: "Я... эм... я не пялюсь на твои ноги! Но конспекты принесу.",
        result: [
        {
          type: "received",
          text: "Да ладно, не смущайся! Я знаю, что они тебе нравятся 😘",
          delay: 1000
        },
        {
          type: "received",
          text: "Жду тебя в 19:00! Не опаздывай и не забудь конспекты! 📒",
          delay: 2500
        }],
        nextChapter: "chapter_homework_3"
      },
      {
        text: "Звучит заманчиво! Обязательно принесу конспекты.",
        result: [
        {
          type: "received",
          text: "Хаха, я так и знала! 😂 Парни такие предсказуемые...",
          delay: 1000
        },
        {
          type: "received",
          text: "Приходи к семи вечера! И смотри, без конспектов — никаких фоточек! 🚫📸",
          delay: 2500
        }],
        nextChapter: "chapter_homework_3"
      }],
    ...
    chapter_homework_3:
    {
      ...
      {
        type: "received",
        text: "Ты уже идёшь? Я приготовила нам чай и печеньки 🍪",
        delay: 1000
      },
      {
        type: "sent",
        text: "Уже выхожу! Конспекты собрал и положил в рюкзак.",
        delay: 2500
      },
      {
        type: "received",
        text: "Молодец! Жду-жду 😊",
        delay: 4000
      },
      {
        type: "system",
        text: "*Два часа спустя*",
        delay: 5500
      },
      {
        type: "received",
        text: "Уф, наконец-то закончили с этими интегралами! 🧮 Спасибо тебе огромное, без тебя я бы не разобралась!",
        delay: 7000
      },
      {
        type: "received",
        text: "И твои конспекты очень помогли! Ты такой организованный... в отличие от меня 😅",
        delay: 8500
      },
      ],
      choices: [
      {
        text: "Рад, что смог помочь! Было весело заниматься вместе.",
        result: [
        {
          type: "received",
          text: "Да, с тобой даже математика становится интересной! 😄",
          delay: 1000
        },
        {
          type: "received",
          text: "Так... Кажется, я тебе что-то обещала за конспекты, верно? 😏",
          delay: 2500
        }],
        nextChapter: "chapter_homework_4"
      },
      {
        text: "Не забыла про свое обещание?",
        result: [
        {
          type: "received",
          text: "Ого, какой нетерпеливый! 😂",
          delay: 1000
        },
        {
          type: "received",
          text: "Не волнуйся, я помню. Слово девушки! 💫",
          delay: 2500
        }],
        nextChapter: "chapter_homework_4"
      }],
    ...
    chapter_homework_4:
    {
      ...
      {
        type: "received",
        text: "Подожди минутку... Я сейчас вернусь! 🏃‍♀️",
        delay: 1000
      },
      {
        type: "system",
        text: "*Девушка возвращается через несколько минут*",
        delay: 2500
      },
      {
        type: "received",
        text: "Я как раз сняла носочки... После учёбы ножки так устали! 😩",
        delay: 4000
      },
      {
        type: "received",
        text: "Смотри, как обещала! {{photo}}",
        delay: 5500
      },
      {
        type: "received",
        text: "Ой, они немного грязные и вспотели... Я сегодня весь день в кроссовках бегала 🙈",
        delay: 7000
      },
      ],
      choices: [
      {
        text: "Вау... они... эм... очень милые! Спасибо за фото!",
        result: [
        {
          type: "received",
          text: "Хаха, ты такой смущённый! Это так мило 😂",
          delay: 1000
        },
        {
          type: "received",
          text: "Нравятся мои грязные пяточки? 😏 Тебе нечего стесняться!",
          delay: 2500
        }],
        nextChapter: "chapter_homework_5"
      },
      {
        text: "Они просто идеальны... даже с пылью и потом.",
        result: [
        {
          type: "received",
          text: "Ого! Да ты и правда фанат ножек! 👣",
          delay: 1000
        },
        {
          type: "received",
          text: "Никогда бы не подумала, что тебе понравятся даже в таком состоянии... Интересно! 🤔",
          delay: 2500
        }],
        nextChapter: "chapter_homework_5"
      },
      {
        text: "Эм... спасибо, но тебе не обязательно было это делать.",
        result: [
        {
          type: "received",
          text: "Да ладно тебе! Я вижу, как ты покраснел! 😂",
          delay: 1000
        },
        {
          type: "received",
          text: "Признайся, тебе ведь нравится? Давай, не стесняйся! 😏",
          delay: 2500
        }],
        nextChapter: "chapter_homework_5"
      }],
    ...
    chapter_homework_5:
    {
      ...
      {
        type: "sent",
        text: "Если честно... я просто в восторге от твоих ножек.",
        delay: 1000
      },
      {
        type: "received",
        text: "Правда? 😊 Расскажи подробнее! Что именно тебе нравится?",
        delay: 2500
      },
      ],
      choices: [
      {
        text: "Они такие изящные и красивые... Я бы отдал жизнь, чтобы помыть их своим языком.",
        result: [
        {
          type: "received",
          text: "ВАУ! 😳 Не ожидала от тебя такой... откровенности!",
          delay: 1000
        },
        {
          type: "received",
          text: "Хахаха, да ты полный извращенец! 🤣 Боже, я не могу перестать смеяться!",
          delay: 2500
        }],
        nextChapter: "chapter_homework_6"
      },
      {
        text: "Ты не представляешь, как я мечтаю вылизать каждый твой пальчик... даже с грязью и потом.",
        result: [
        {
          type: "received",
          text: "ОМГ! 😱 Серьёзно? Даже с грязью?!",
          delay: 1000
        },
        {
          type: "received",
          text: "Хахаха! Вот это да! Не знала, что ты такой... целеустремлённый! 🤭",
          delay: 2500
        }],
        nextChapter: "chapter_homework_6"
      },
      {
        text: "Я бы всё отдал, чтобы быть ковриком у твоих ног... и чувствовать, как ты ходишь по мне.",
        result: [
        {
          type: "received",
          text: "БОЖЕ! 😂 Да ты просто помешан на ножках!",
          delay: 1000
        },
        {
          type: "received",
          text: "Никогда бы не подумала, что мой одногруппник хочет быть моим ковриком! Это так забавно! 🙈",
          delay: 2500
        }],
        nextChapter: "chapter_homework_6"
      }],
    ...
    chapter_homework_6:
    {
      ...
      {
        type: "sent",
        text: "Прости... Я не хотел тебя смущать. Просто... не смог сдержаться.",
        delay: 1000
      },
      {
        type: "received",
        text: "Да ладно тебе! Это даже мило! 😄",
        delay: 2500
      },
      {
        type: "received",
        text: "И знаешь что... если будешь хорошим мальчиком... 😏",
        delay: 4000
      },
      {
        type: "received",
        text: "Если будешь слушаться и помогать мне с учёбой... может быть, я разрешу тебе помыть мои ножки. И не только водой... 👅💦",
        delay: 5500
      },
      {
        type: "received",
        text: "Но это только если будешь ОЧЕНЬ послушным! Ясно? 😈",
        delay: 7000
      },
      ],
      choices: [
      {
        text: '"Я... я буду самым послушным! Обещаю!"',
        printable: false,
        result: [],
        nextChapter: "chapter15"
      }]
