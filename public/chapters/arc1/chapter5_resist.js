export default {
  translations: {
    ru: {
      ...
      mc4: "Ладно, покажи.",
      lina9: "Вот, смотри....",
      lina9_image: "img/lina_tease.webp",
  ...
  getText(gameState) {
    ...
    return [
      ...
      { type: "received", text: texts.lina2, delay: 2500 },
      { type: "sent", text: texts.mc1, delay: 4000 },
      { type: "received", text: texts.lina3, delay: 5500 },
      { type: "received", text: texts.lina4, delay: 7000 },
      { type: "sent", text: texts.mc2, delay: 8500 },
      { type: "received", text: texts.lina5, delay: 10000 },
      { type: "received", text: texts.lina6, delay: 11500 },
      { type: "sent", text: texts.mc3, delay: 13000 },
      { type: "received", text: texts.lina7, delay: 14500 },
      { type: "received", text: texts.lina8, delay: 16000 },
      { type: "sent", text: texts.mc4, delay: 17500 },
      { 
    type: "photo", 
    text: texts.lina9, 
    delay: 19000, 
    ...
    onAfter: () => {
      ...
      { type: "received", text: texts.lina10, delay: 21500 },
      { type: "sent", text: texts.mc5, delay: 23000 },
      { type: "received", text: texts.lina11, delay: 24500 },
      { type: "received", text: texts.lina12, delay: 26000 },
      { type: "sent", text: texts.mc6, delay: 27500 },
      { type: "received", text: texts.lina13, delay: 29000 },
      { type: "received", text: texts.lina14, delay: 30500 },
      { type: "sent", text: texts.mc7, delay: 32000 },
      { type: "received", text: texts.lina15, delay: 33500 },
      { type: "received", text: texts.lina16, delay: 35000 },
      { type: "sent", text: texts.mc8, delay: 36500 },
      { type: "received", text: texts.lina17, delay: 38000 },
      { type: "received", text: texts.lina18, delay: 39500 },
      { type: "sent", text: texts.mc9, delay: 41000 },
      { type: "received", text: texts.lina19, delay: 42500 },
      { type: "received", text: texts.lina20, delay: 44000 },
      { type: "sent", text: texts.mc10, delay: 45500 },
      { type: "received", text: texts.lina21, delay: 47000, showChoices: true }
    ];
  },
    ...
    return [
      {
        ...
        result: [
          { type: "received", text: texts.result1, delay: 1000, nextChapter: "chapter6_resist" }
        ]
      },
      {
        id: "need_break",
        ...
        result: [
          { type: "received", text: texts.result2, delay: 1000, nextChapter: "chapter6_resist_break" }
        ]
      }
    ];
  }
